...
module.exports = {
  ...
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/zhengjunyaocn', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/zhengjunyao000', // 你的github个人主页 例如 https://github.com/tangly1024
